...
renderHero($pageClass, "Argent de poche", "Un job citoyen pour les 16-18 ans.","/asset/images/demarche/argent-de-poche/argent.png");
...
renderSection(
    ...
    renderActions($pageClass, getLiensPage('argent-de-poche'))
);
